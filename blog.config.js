【夏日纯臻汉化组】《Summer Pockets REFLECTION BLUE》汉化补丁2.0最终版

补丁说明：
 * 本补丁为正式版补丁。
 * 本补丁归【夏日纯臻汉化组】所有。请珍惜劳动成果，不得随意改动。
 * 本补丁仅供试用，请支持正版游戏。
 * 未经允许，严禁将本补丁用于商业用途，若因此触犯法律，本组不承担任何责任。
 * 关于手机版SPRB的使用方法，详情请参照下方网址内的说明。https://github.com/yanhua0518/TemplateStock
 * 此补丁修正了1.0中的BUG和一系列翻译错误&表达不够恰当的地方，对游戏体验受到影响的玩家深表歉意。

Staff
翻译：路歌，请叫我鹿目园，绫丸桑，挪亚方舟，阿天，散言，野渚，樱谷秋羽，篝酱的丝带，霸鸣弥，摸鱼侠MY，地篝，萌风，寿子不瘦；
修图：某虐，神山岩，绫，苏婆玛丽奥，able1214；
歌词特效：霸鸣弥；
程序：霸鸣弥，able1214；
校对&测试：全体组员；
总校对：绫丸桑；
特别鸣谢：枫笛汉化组，死了没法儿忍汉化组；白雪公主梦不见七个小矮人，魔鬼不动的老中医；
制作：夏日纯臻汉化组。

安装方法：
汉化硬盘版：直接解压即可
完整补丁：将汉化补丁解压到游戏目录。
热更新版：解压patch_uodate到游戏目录，覆盖同名文件即可。

运行SiglusEngineGBK.exe启动游戏。
运行SiglusEngine.exe将启动日文版，且存档互通。
另外，本组版本的存档不会和枫笛汉化组版本之间产生冲突。
如果弹出字体设置提示，点“是”选择字体。
建议选择补丁内附带的QingYuanSP或KaiGenSP。

FROM 坑主
这个坑追根揭底，其实只是作为老兜厨的执念才开起来的，能够在今天发出来一个像样的东西，真的很感谢各位同志（岛民）的共同努力。
最后，也望各位岛民，能够在自己的口袋里，找到自己的回忆与初心。
